...
class ConcreteNodeHandler(NodeHandler):
    ...
    def accept(self, nodes: List[Node], **kwargs: Any) -> Generator[Node, None, None]:
...
class TestNodeHandlerEdgeCases:
    ...
    def test_handle_large_node_list(self):
        ...
        handler = ConcreteNodeHandler()
        nodes = [Node(text=f"Node {i}") for i in range(1000)]
        result = handler(nodes)
    ...
    def test_handle_nodes_with_metadata(self):
        ...
        handler = ConcreteNodeHandler()
        nodes = [
            Node(text="Node 1", metadata={"key": "value1"}),
            Node(text="Node 2", metadata={"key": "value2"})
        ]
        result = handler(nodes)
    ...
    def test_handle_nodes_with_different_types(self):
        ...
        handler = ConcreteNodeHandler()
        nodes = [
            Node(text="Text node 1"),
            Node(text="Text node 2"),
        ]
        result = handler(nodes)
...
class TestNodeHandlerAcceptMethod:
    ...
    def test_accept_yields_nodes(self):
        ...
        handler = ConcreteNodeHandler()
        nodes = [Node(text="Node 1"), Node(text="Node 2")]
...
class TestNodeHandlerIntegration:
    ...
    def test_process_document_chunks(self):
        ...
        handler = ConcreteNodeHandler()
        chunks = [
            Node(text="Chapter 1: Introduction", metadata={"chapter": 1}),
            Node(text="Chapter 2: Background", metadata={"chapter": 2}),
            Node(text="Chapter 3: Methods", metadata={"chapter": 3})
        ]
    ...
    def test_process_nodes_with_ids(self):
        ...
        handler = ConcreteNodeHandler()
        nodes = [
            Node(text="Node 1", node_id="node-001"),
            Node(text="Node 2", node_id="node-002")
        ]
        ...
        assert result[1].node_id == "node-002"
